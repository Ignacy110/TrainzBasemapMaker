...
{
    // A helper class that handles coordinate system transformations for EPSG:2180 (Poland CS92 / ETRS89)
    internal static class GeoHelperEPSG2180
    {
        ...
        /// <summary>
        /// Checks whether the given geographic coordinates (Lat, Lon) fall within the bounding box of Poland.
        /// </summary>
        ...
        /// <summary>
        /// Checks whether the given metric coordinates (X, Y) fall within the valid EPSG:2180 boundary limits for Poland.
        /// </summary>
        ...
        /// <summary>
        /// Converts geographic coordinates (WGS84 Latitude/Longitude in degrees) to projected meters in EPSG:2180.
        /// </summary>
        ...
        /// <summary>
        /// Converts projected meters in EPSG:2180 to geographic coordinates (WGS84 Latitude/Longitude in degrees).
        /// </summary>
